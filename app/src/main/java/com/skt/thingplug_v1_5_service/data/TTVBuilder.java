    ...
    public static List<SensorInfo> parseSensorData(String tdvString) {
        ...
        for (int loop1 = 0 ; loop1 < size ; ) {
            ...
            switch (type) {
                ...
                case 0x01:  sensorType = SensorType.AMBIENT_TEMPERATURE;    intValues[0] = convertStrToFloat(value);                            break;  // temperature
                case 0x02:  sensorType = SensorType.RELATIVE_HUMIDITY;      intValues[0] = Long.parseLong(value, 16);                           break;  // humidity
                case 0x03:  sensorType = SensorType.LIGHT;                  intValues[0] = Long.parseLong(value, 16);                           break;  // light
                case 0x0A:  sensorType = SensorType.MEMORY;                 intValues[0] = Long.parseLong(value, 16);                           break;  // free memory
