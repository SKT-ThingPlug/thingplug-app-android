...
public enum SensorType {
    ...
    AMBIENT_TEMPERATURE        (Category.SENSOR_MANAGER,    "Temperature",                  R.mipmap.icon_temperature_big,      ValueType.NUMBER,   new int[]{0x11},                new int[]{0x01},                new int[]{2},           new String[][]{{"Ambient temperature", "℃"}}),                              // This constant was deprecated in API level 14. use Sensor.TYPE_AMBIENT_TEMPERATURE instead.
    RELATIVE_HUMIDITY          (Category.SENSOR_MANAGER,    "Humidity",                     R.mipmap.icon_humidity_big,         ValueType.NUMBER,   new int[]{0x12},                new int[]{0x02},                new int[]{0},           new String[][]{{"Air humidity", "%"}}),                                     // A constant describing a relative humidity sensor type.
    LIGHT                      (Category.SENSOR_MANAGER,    "Light",                        R.mipmap.icon_light_big,            ValueType.NUMBER,   new int[]{0x25},                new int[]{0x03},                new int[]{0},           new String[][]{{"Level", "㏓"}}),                                           // A constant describing a light sensor type.
    MEMORY                     (Category.SENSOR_MANAGER,    "Free Memory",                  R.mipmap.icon_batterygauge_big,     ValueType.NUMBER,   new int[]{0x0A},                new int[]{0x0A},                new int[]{0},           new String[][]{{"Free Memory", "MB"}}),                                     // A constant describing a free system memory.
    ...
    BUZZER                     (Category.ACTUATOR,          "Buzzer",                       R.mipmap.icon_buzzer_big,           ValueType.NUMBER,   new int[]{0x87},                new int[]{0x87},                new int[]{0},           new String[][]{{"", ""}}),
    LED                        (Category.ACTUATOR,          "Led",                          R.mipmap.icon_color_big,            ValueType.NUMBER,   new int[]{0x88},                new int[]{0x88},                new int[]{0},           new String[][]{{"", ""}}),
    ...
    CAMERA                     (Category.ACTUATOR,          "Camera",                       R.mipmap.icon_camera_big,           ValueType.NUMBER,   new int[]{0x84},                new int[]{0x84},                new int[]{0},           new String[][]{{"", ""}}),
    ...
    DEVICE                     (Category.ACTUATOR,          "Device",                       -1,                                 ValueType.NUMBER,   new int[]{0x9F},                new int[]{0x9F},                new int[]{0},           null),
